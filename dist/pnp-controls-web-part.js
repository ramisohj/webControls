define("8909dae1-5562-4f0f-be6c-aa14eac34c66_0.0.2", ["react","react-dom","@microsoft/sp-webpart-base","PnPControlsWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var PnPControls_1 = __webpack_require__(9);
var PnPControlsWebPart = (function (_super) {
    __extends(PnPControlsWebPart, _super);
    function PnPControlsWebPart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PnPControlsWebPart.prototype.render = function () {
        var element = React.createElement(PnPControls_1.default, {
            context: this.context,
            description: this.properties.description
        });
        ReactDom.render(element, this.domElement);
    };
    PnPControlsWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
    ...
    return PnPControlsWebPart;
}(sp_webpart_base_1.BaseClientSideWebPart));
exports.default = PnPControlsWebPart;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(2);
var sp_1 = __webpack_require__(10);
...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "spExtractODataId", function() { return spExtractODataId; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SearchSuggestResult", function() { return SearchSuggestResult; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pnp_common__ = __webpack_require__(4);
...
var Fields = /** @class */ (function (_super) {
    ...
    */
    Fields.prototype.addUser = function (title, selectionMode, properties) {
        ...
        return this.add(title, "SP.FieldUser", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addChoice = function (title, choices, format, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldChoice", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultiChoice = function (title, choices, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldMultiChoice", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* Util */].extend(props, properties));
    };
    /**
    ...
    Fields.prototype.addBoolean = function (title, properties) {
        ...
        return this.add(title, "SP.Field", __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* Util */].extend(props, properties));
    };
    return Fields;
}(SharePointQueryableCollection));
/**
    ...
    ClientSidePage.create = function (library, pageName, title, pageLayoutType) {
        ...
        return library.rootFolder.files.select("Name").filter("Name eq '" + pageName + "'").get().then(function (fs) {
            ...
            return library.rootFolder.select("ServerRelativePath").get().then(function (path) {
                var pageServerRelPath = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* Util */].combinePaths("/", path.ServerRelativePath.DecodedUrl, pageName);
...
var CanvasControl = /** @class */ (function () {
    function CanvasControl(controlType, dataVersion, column, order, id, controlData) {
        ...
        if (id === void 0) { id = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* Util */].getGUID(); }
...
var TimeZone = /** @class */ (function (_super) {
    ...
    TimeZone.prototype.localTimeToUTC = function (localTime) {
        ...
        if (typeof localTime === "string") {
            ...
            dateIsoString = __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* Util */].dateAdd(localTime, "minute", localTime.getTimezoneOffset() * -1).toISOString();
        }
...
var SocialQuery = /** @class */ (function (_super) {
    ...
    SocialQuery.prototype.createSocialActorInfoRequestBody = function (actorInfo) {
        return JSON.stringify({
            "actor": __WEBPACK_IMPORTED_MODULE_1__pnp_common__["e" /* Util */].extend({
                Id: null,
...
/***/ })
/******/ ])});;
//# sourceMappingURL=pnp-controls-web-part.js.map